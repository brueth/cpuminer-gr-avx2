...
#define CRYPTONIGHT_HASH(variant, way)                                         \
  ...
  if (way == CN_8WAY) {                                                      \
    cryptonight_8way_hash<variant, pref>(hash0, hash1, hash2, hash3, hash4, hash5, hash6, hash7,
                                          hash0, hash1, hash2, hash3, hash4, hash5, hash6, hash7);               \
  } else if (way == CN_4WAY) {                                                      \
    cryptonight_4way_hash<variant, pref>(hash0, hash1, hash2, hash3,
                                        hash0, hash1, hash2, hash3);               \
    cryptonight_4way_hash<variant, pref>(hash4, hash5, hash6, hash7,
                                        hash4, hash5, hash6, hash7);                                            
  } else if (way == CN_2WAY) {                                               \
    cryptonight_2way_hash<variant, pref>(hash0, hash1, hash0, hash1);        \
    cryptonight_2way_hash<variant, pref>(hash2, hash3, hash2, hash3);        \
    cryptonight_2way_hash<variant, pref>(hash4, hash5, hash4, hash5);        \
    cryptonight_2way_hash<variant, pref>(hash6, hash7, hash6, hash7);        \      
  } else {                                                                   \
    ...
    cryptonight_hash<variant, pref>(hash4, hash4);                           \
    cryptonight_hash<variant, pref>(hash5, hash5);                           \
    cryptonight_hash<variant, pref>(hash6, hash6);                           \
    cryptonight_hash<variant, pref>(hash7, hash7);                           \
  }                                                                          \
                                                                    \
  vectorized = false;
...
int gr_4way_hash(void *output, const void *input, const int thr_id) {
  ...
  uint64_t vhashC[10 * 2] __attribute__((aligned(128)));
  uint64_t vhashD[10 * 2] __attribute__((aligned(128)));
  ...
  uint64_t hash4[10] __attribute__((aligned(64)));
  uint64_t hash5[10] __attribute__((aligned(64)));
  uint64_t hash6[10] __attribute__((aligned(64)));
  uint64_t hash7[10] __attribute__((aligned(64)));
